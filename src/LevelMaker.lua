...
function LevelMaker.createMap(level)
    ...
    --[[Create a random number between 1 and 2 for locked brick generation. Since
        the instructions state that a locked brick should only show up occassionally,
        we will use the random number to show a locked brick.
    
        1 = show a locked brick
        2 = don't show a locked brick
    ]]
    local generateLockedBrick = math.random(1, 2)
