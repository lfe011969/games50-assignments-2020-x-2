...
function Brick:init(x, y)
    ...
    -- Add a boolean for whether the brick is locked
    self.isLocked = false
...
function Brick:hit()
    ...
    -- Added code to check whether the brick being hit is a locked brick
...
function Brick:render()
    if self.inPlay then
        ...
        -- Added code to draw a locked brick if the isLocked boolean is true
        if self.isLocked then
