...
function love.load()
    ...
    gFrames = {
        ...
        -- Add entry for powerup
        ['powerups'] = GenerateQuadsPowerups(gTextures['main']),
        
        -- Add entry for locked brick
    ...
    gSounds = {
        ...
        -- Add new sounds for powerup collection, hitting the locked brick, and
        -- for destroying the locked brick
        ['powerup-collect'] = love.audio.newSource('sounds/powerup1.wav'),
        ['brick-hit-lock'] = love.audio.newSource('sounds/lockedBrick.wav'),
        ['locked-brick-explode'] = love.audio.newSource('sounds/lockedBrickExplode.wav'),
